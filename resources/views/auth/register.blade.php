			...
			<div class="footer-top">
				<div class="col-md-4 amet-sed">
					...
					<p>Somos un grupo de gamers que conocemos el mercado en su totalidad, el cual ayudamos a nuestros
						clientes a conseguir cualquier pieza de hardware o videoconsola de manera rápida y eficiente sin
						tener que visitar páginas sospechosas o engañosas, Game Solutions está hecha por gamers para
						gamers. </p>
				</div>
