...
<body>
	...
	<!-- shop -->
	<div class="modal-content">
		<img src="<?php echo url('/');?>/images/b.jpg" style="width:100%;">
	</div>
	<div class="modal-content">
		<img src="<?php echo url('/');?>/images/ds5.jpg" style="width:100%;">	
	</div>
	<div class="modal-content">
		<img src="<?php echo url('/');?>/images/gms.jpg" style="width:100%">
	</div>
	<!-- //shop -->
	<!-- footer -->
	<div class="footer">
